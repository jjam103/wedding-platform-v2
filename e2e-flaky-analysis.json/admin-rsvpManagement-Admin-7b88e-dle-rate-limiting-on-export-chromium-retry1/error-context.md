...
- generic [ref=e1]:
                ...
                - group "Filter controls" [ref=e71]:
                  ...
                  - generic [ref=e78]:
                    ...
                    - combobox "Filter by Status" [ref=e80]:
                      ...
                      - option "Declined"
                      - option "Maybe"
                - button "Export RSVPs to CSV" [active] [ref=e82] [cursor=pointer]: Export
  ...
  - region "Notifications":
    - alert [ref=e129]:
      - img [ref=e131]
      - paragraph [ref=e134]: Failed to export RSVPs
      - button "Close notification" [ref=e135]:
        - img [ref=e136]
    - alert [ref=e139]:
      - img [ref=e141]
      - paragraph [ref=e144]: Failed to export RSVPs
      - button "Close notification" [ref=e145]:
        - img [ref=e146]
```